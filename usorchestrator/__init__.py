...
def main():
   ...
   show_parser.add_argument('--type', help='Show informations regarding different action types', choices=['hosts_groups', 'routines'], required=True)
   ...
   orchestrate_parser.add_argument('--data', dest='data', help='Data to be passed to the given routine (key=value)', action='append')
